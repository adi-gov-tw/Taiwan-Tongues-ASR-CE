...
| 任務 | 方案 | 建議硬體規格 | 預估時間 |
| :--- | :--- | :--- | :--- |
| **推論** | **CPU** | **CPU：** 高階多核 CPU、核心/執行緒 16+、基礎時脈 3.0 GHz+<br>**RAM：** 32 GB 或更高 | 以 5 分鐘音檔估算，約需 **7 分鐘** |
| **推論** | **CUDA** | **GPU：** 10 GB VRAM 以上<br>*(如：RTX 3080/4070 Ti 或專業卡 A40/A5000)*<br>**RAM：** 16 GB - 32 GB | 以 5 分鐘音檔估算，約需 **30 秒** |
| **訓練/微調** | **CPU** | **CPU：** 伺服器級多核心 CPU、核心/執行緒 32+、基礎時脈 2.5 GHz+<br>**RAM：** 128 GB 或更高 | **不建議執行**<br>*(極慢且效率極低，通常只用於資料預處理)* |
| **訓練/微調** | **CUDA** | **GPU：** 40 GB VRAM 以上<br>*(如：NVIDIA A100/H100 或多張 RTX 4090)*<br>**RAM：** 128 GB 或更高 | 以 200 小時音訊評估，約需 **72 小時** |
